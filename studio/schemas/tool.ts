...
export const tool = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      validation: (Rule) =>
        Rule.custom((value, context) => {
          const hasTitle = !!(context.document as { ctaTitle?: string } | undefined)?.ctaTitle;
    ...
    defineField({
      ...
      type: "string",
      group: "features",
      description: "Small label above the heading. Defaults to localized 'FEATURES' if empty.",
    }),
    defineField({
